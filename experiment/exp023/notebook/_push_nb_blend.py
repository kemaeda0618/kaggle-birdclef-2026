"""Push exp023: exp019 base + species-level wet/dry empirical prior.

slug: birdclef2026-exp023-blend-w35-40-25-wd
- exp019 (w35-40-25, LB 0.947) + post-FCS multiplicative wet/dry prior
- prior table は inline 構築 (train_soundscapes_labels.csv from competition_sources)
- 命名規約 拡張: birdclef2026-exp{NNN}-blend-w{NB4*100}-{Tucker*100}-{e17*100}-{features}
- 期待 LB 0.949-0.952
"""
...
NB = Path(__file__).with_name("nb_blend_w35-40-25_wd.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp023-blend-w35-40-25-wd"
TITLE = "birdclef2026-exp023-blend-w35-40-25-wd"
