"""Push M7 training NB (Babych b0 + 63-class supervised)."""
...
NB = Path(__file__).with_name("nb_train_m7.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp076-m7-train"
TITLE = "birdclef2026 exp076 m7 train"
