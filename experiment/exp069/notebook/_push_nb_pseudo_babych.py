"""Push exp069a Babych pseudo gen NB to Kaggle (T4x2 GPU enabled)."""
...
NB = Path(__file__).with_name("nb_pseudo_babych.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp069a-babych-pseudo-gen"
TITLE = "birdclef2026 exp069a babych pseudo gen"
