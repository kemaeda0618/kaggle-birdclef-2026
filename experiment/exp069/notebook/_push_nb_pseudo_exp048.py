"""Push exp069b exp048 blend pseudo gen NB to Kaggle (CPU, internet=True)."""
...
NB = Path(__file__).with_name("nb_pseudo_exp048.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp069b-exp048-pseudo"
TITLE = "birdclef2026 exp069b exp048 pseudo"
