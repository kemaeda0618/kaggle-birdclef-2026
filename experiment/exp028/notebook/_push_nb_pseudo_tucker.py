...
NB    = Path(__file__).with_name("nb_pseudo_tucker.ipynb")
USER  = "maekeso"
SLUG  = "birdclef2026-exp028-pseudo-hgnetv2-tucker"
TITLE = "birdclef2026 exp028 pseudo hgnetv2 tucker"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "dataset_sources": [
            "tuckerarrants/bc2026-distilled-sed-public",   # Tucker 5-fold ONNX
