"""Push exp028 ProtoSSM-only + Sonotype mirror (existing + Tier 1 new) to Kaggle."""
...
NB = Path(__file__).with_name("nb_protossm_mirror.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp028-protossm-mirror"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp028 protossm mirror",
        "code_file": NB.name,
        "language": "python",
