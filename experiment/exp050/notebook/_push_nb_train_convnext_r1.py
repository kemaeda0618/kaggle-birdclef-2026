"""Push exp050 ConvNeXt-pico R1 train NB."""
...
NB = Path(__file__).with_name("nb_train_convnext_r1.ipynb")
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td / NB.name)
    meta = {
        "id": "maekeso/birdclef2026-exp050-convnext-pico-r1",
        "title": "birdclef2026 exp050 convnext pico r1",
