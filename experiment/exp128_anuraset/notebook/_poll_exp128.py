"""Poll exp128 training kernel until finished, then pull log + outputs."""
...
REF = "maekeso/birdclef2026-exp128-train-amphibian"
while True:
    try:
    ...
    time.sleep(60)
out = Path("experiment/exp128_anuraset/notebook/_out"); out.mkdir(exist_ok=True)
try:
