"""Push exp152: exp110 with seed 618 (birthday). Submit NB, internet=False."""
...
NB = Path(__file__).with_name("nb_exp152_seed618.ipynb")
# NOTE: original slug "birdclef2026-exp152-seed618" got soft-reserved in a broken state by a
# failed first push ("Notebook not found"); using a fresh slug worked. Keep this one.
USER = "maekeso"; SLUG = "birdclef2026-exp152-bday618"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp152 bday618",
        "code_file": NB.name,
