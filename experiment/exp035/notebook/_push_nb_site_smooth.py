"""Push exp035 site smoothing NB to Kaggle (CPU, internet OFF)."""
...
NB    = Path(__file__).with_name("nb_site_smooth.ipynb")
USER  = "maekeso"
SLUG  = "birdclef2026-exp035-site-smoothing"  # V1 で title 由来 slug 確定済
TITLE = "birdclef2026 exp035 site smoothing"
