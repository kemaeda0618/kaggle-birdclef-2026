"""Push exp067 (exp048 + Cross-Dialect calibration)."""
...
NB = Path(__file__).with_name("nb_blend_dialect.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp067-dialect"
TITLE = "birdclef2026 exp067 dialect"
