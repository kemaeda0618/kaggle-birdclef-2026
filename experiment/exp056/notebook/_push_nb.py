...
NB = Path(__file__).with_name("nb_blend_aves_stage2a.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp056-aves-stage2a"
TITLE = "birdclef2026 exp056 aves stage2a"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "dataset_sources": [
            ...
            "maekeso/birdclef2026-exp053-stage2a-effv2s",
        ],
        "kernel_sources": [
