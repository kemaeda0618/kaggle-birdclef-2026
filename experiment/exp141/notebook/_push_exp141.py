"""Push exp141: exp110 + amphibian v5 surgical (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp141_amphib_v5_surgical.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp141-amphib-v5-surgical"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp141 amphib v5 surgical",
        "code_file": NB.name,
        ...
        "dataset_sources": [
            ...
            f"{USER}/birdclef2026-amphib-b0-v5",
        ],
