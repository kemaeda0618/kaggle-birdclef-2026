"""Push exp104 V3 (Tucker 3-fold + exp102 3-fold OV) submission NB."""
...
NB = Path(__file__).with_name("nb_exp104_v3_tucker3fold.ipynb")
USER = "maekeso"
# new slug for V3 to avoid version conflict with V2 (which timeout)
SLUG = "birdclef2026-exp104-v3-tucker3fold"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp104 v3 tucker3fold",  # 35 chars
        "code_file": NB.name,
        "language": "python",
