"""Push exp104 standalone: exp102 3-fold ensemble OV only."""
...
NB = Path(__file__).with_name("nb_exp104_standalone_3fold.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp104-standalone-3fold"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp104 standalone 3fold",  # 38 chars
        "code_file": NB.name,
        "language": "python",
