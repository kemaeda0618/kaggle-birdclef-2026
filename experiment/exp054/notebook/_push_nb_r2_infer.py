...
NB = Path(__file__).with_name("nb_r2_infer.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp054-r2-infer"
TITLE = "birdclef2026 exp054 r2 infer"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "dataset_sources": ["maekeso/birdclef2026-exp054-stage2-r2-effv2s"],
        "kernel_sources": [],
    }
