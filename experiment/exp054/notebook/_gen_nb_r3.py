"""Generate R3 NB: R2 teacher → improved pseudo → R3 train.

R2 (LB 0.78+ expected) is much better teacher than R1 (LB 0.749).
- R2 teacher: generate new high-quality pseudo on train_soundscapes
- R3 student: warm start from R2, train on real + R2_pseudo
"""
import json
...
nb = {
    "cells": [
        md_cell("hdr", """# exp054 R3 — Improved Pseudo + R3 Train (Colab Blackwell)
...
"""),
        ...
        code_cell("dl_data", """# Cell 2: Download R2 ckpt + BC2026 data
...
"""),
        ...
        code_cell("config", """# Cell 5: R3 training config
CFG = dict(
...
"""),
        ...
        code_cell("model", """# Cell 6: Model + R2 backbone load (teacher + student)
...
"""),
        ...
        code_cell("pseudo_gen", """# Cell 7: Pseudo gen with R2 teacher (better than R1 pseudo)
LOCAL_DATA = Path("/content/data")
BC_DIR = LOCAL_DATA / "birdclef-2026"
...
"""),
        ...
        code_cell("data_meta", """# Cell 8: build R3 train data (same logic as R2)
...
"""),
        ...
        code_cell("dataset", """# Cell 9: Dataset (same as R2)
...
"""),
        ...
        code_cell("aug", """# Cell 10: Aug (same)
...
"""),
        ...
        code_cell("train_loop", """# Cell 13: R3 train loop
best_val = 0.0
...
"""),
        ...
        code_cell("upload_kaggle", """# Cell 14: upload R3 to Kaggle Dataset (self-contained auth)
