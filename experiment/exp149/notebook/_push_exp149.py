"""Push exp149: exp110 + site/hour prior applied LAST (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp149_prior_last.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp149-prior-last"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp149 prior last",
        "code_file": NB.name,
