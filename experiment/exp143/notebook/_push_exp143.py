"""Push exp143: exp110 reweighted EQUAL 0.333/0.334/0.333 (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp143_blend_333_334_333.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp143-blend-333-334-333"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp143 blend 333 334 333",
        "code_file": NB.name,
