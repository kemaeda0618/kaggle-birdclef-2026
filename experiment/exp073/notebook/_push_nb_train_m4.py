"""Push M4 train NB (b3 20s Babych init)."""
...
NB = Path(__file__).with_name("nb_train_m4.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp073-m4-b3-20s-babych"
TITLE = "birdclef2026 exp073 m4 b3 20s babych"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "kernel_sources": [
            "maekeso/birdclef2026-exp069c-hybrid-merge",
        ],
    }
