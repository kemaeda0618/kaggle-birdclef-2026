"""Push exp061 inline 4-way (exp048 base + exp058 effv2_b0)."""
...
USER = "maekeso"
SLUG = "birdclef2026-exp061-blend-exp048-exp058"
TITLE = "birdclef2026 exp061 blend exp048 exp058"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "dataset_sources": [
            ...
            # NEW: exp058 effv2_b0 ckpt
            "maekeso/birdclef2026-exp058-effv2b0-combined",
        ],
        "kernel_sources": [
