"""Push exp010 v8 + Gates 1/2/3 (no BirdNET) to same slug birdclef2026-exp010-blend-tucker-sed."""
...
NB = Path(__file__).with_name("nb_blend_tucker_gates.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp010-blend-tucker-sed"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-exp010-blend-tucker-sed",
        "code_file": NB.name,
        "language": "python",
