"""Push v9 (v8 + G28 Student-t smoothing)."""
...
NB = Path(__file__).with_name("nb_blend_tucker_v9_g28.ipynb")
SLUG = "birdclef2026-exp010-blend-tucker-v9-g28"
TITLE = "BirdCLEF2026 exp010 Blend Tucker V9 G28"
