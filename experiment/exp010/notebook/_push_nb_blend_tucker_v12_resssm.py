"""Push v12 (v11 + ResidualSSM second-pass, from exp040)."""
...
# New slug per user request — v11 (LB 0.926) は別 slug で保全、v12+ResSSM を独立 kernel に。
# Title slug 派生規則: "BirdCLEF2026 exp10 protossm" → "birdclef2026-exp10-protossm"
SLUG = "birdclef2026-exp10-protossm"
TITLE = "BirdCLEF2026 exp10 protossm"

with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td / NB.name)
    meta = {
        "id": f"maekeso/{SLUG}", "title": TITLE, "code_file": NB.name,
