"""Push exp010 NB4 (ProtoSSM + MLP Blend) to Kaggle via SDK."""
...
NB = Path(__file__).with_name("nb4_blend.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp010-nb4-blend-protossm-mlp"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-exp010-nb4-blend-protossm-mlp",
        "code_file": NB.name,
        "language": "python",
