"""Push v10 (v8 + G27 rank-based gate)."""
...
NB = Path(__file__).with_name("nb_blend_tucker_v10_g27.ipynb")
SLUG = "birdclef2026-exp010-blend-tucker-v10-g27"
TITLE = "BirdCLEF2026 exp010 Blend Tucker V10 G27"
