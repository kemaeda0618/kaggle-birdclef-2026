"""Push exp010 NB8 (Inference with NB7 pretrained MLP) to Kaggle."""
...
NB = Path(__file__).with_name("nb8_inference.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp010-nb8-inference"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-exp010-nb8-inference",
        "code_file": NB.name,
        "language": "python",
        ...
        "kernel_sources": [
            ...
            "maekeso/birdclef2026-exp010-nb7-pretrain-mlp",
        ],
    }
