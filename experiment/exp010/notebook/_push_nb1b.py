"""Push exp010 NB1b (Perch embeddings for AnuraSet) to Kaggle."""
...
NB = Path(__file__).with_name("nb1b_perch_anura.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-perch-anura"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-perch-anura",
        "code_file": NB.name,
        "language": "python",
