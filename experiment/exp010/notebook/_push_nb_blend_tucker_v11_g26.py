"""Push v11 (v8 + G26 Per-class Isotonic + F1 threshold)."""
...
NB = Path(__file__).with_name("nb_blend_tucker_v11_g26.ipynb")
SLUG = "birdclef2026-exp010-blend-tucker-v11-g26"
TITLE = "BirdCLEF2026 exp010 Blend Tucker V11 G26"
