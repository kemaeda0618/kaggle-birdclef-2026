"""Push exp010 NB5 (Noisy Student multi-round training) to Kaggle."""
...
NB = Path(__file__).with_name("nb5_noisy_student.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp010-nb5-noisy-student"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-exp010-nb5-noisy-student",
        "code_file": NB.name,
        "language": "python",
