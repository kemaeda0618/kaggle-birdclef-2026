"""Push exp010 NB7 (MLP pretrain + fine-tune) to Kaggle."""
...
NB = Path(__file__).with_name("nb7_pretrain_mlp.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp010-nb7-pretrain-mlp"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-exp010-nb7-pretrain-mlp",
        "code_file": NB.name,
        "language": "python",
