"""Push NB4-AVES (NB4 v7 architecture with AVES instead of Perch)."""
...
NB = Path(__file__).with_name("nb4_aves.ipynb")
SLUG = "birdclef2026-exp010-nb4-aves"
