"""Push exp010+exp012 blend submission notebook."""
...
NB = Path(__file__).with_name("nb_blend_exp012.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp010-blend-exp012"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-exp010-blend-exp012",
        "code_file": NB.name,
        "language": "python",
        ...
        "kernel_sources": [
            ...
            "maekeso/birdclef2026-exp012-train-fold0",
        ],
    }
