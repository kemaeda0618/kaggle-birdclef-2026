"""Push exp010 NB6 (Inference with NB5 NS weights) to Kaggle."""
...
NB = Path(__file__).with_name("nb6_inference_ns.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp010-nb6-inference-ns"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026-exp010-nb6-inference-ns",
        "code_file": NB.name,
        "language": "python",
        ...
        "kernel_sources": [
            ...
            "maekeso/birdclef2026-exp010-nb5-noisy-student",
        ],
    }
