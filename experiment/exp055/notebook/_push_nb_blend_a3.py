"""Push exp055 A3 retrieval dedup blend NB."""
...
NB = Path(__file__).with_name("nb_blend_a3.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp055-a3-blend"
TITLE = "birdclef2026 exp055 a3 blend"

with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td / NB.name)
    # Reuse exp048 dependencies
    meta = {
