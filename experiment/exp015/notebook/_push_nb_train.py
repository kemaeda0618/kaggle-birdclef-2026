"""Push exp015 nb_train.ipynb to Kaggle as T4x2 GPU NB with self-resume support.

First push: maekeso/exp015-state dataset may not exist yet — try with it
...
Slug rule (title slugifies to slug):
  title = "birdclef2026 exp015 train"
  slug  = "birdclef2026-exp015-train"
"""
...
USER  = "maekeso"
SLUG  = "birdclef2026-exp015-train"
TITLE = "birdclef2026 exp015 train"   # slugifies to birdclef2026-exp015-train
...
# Try with exp015-state attached (resume mode). If it doesn't exist yet, fall back.
WITH_STATE = [
...
try:
    ...
    if "not found" in msg.lower() or "404" in msg or "exp015-state" in msg:
        print(f"\nRetrying without {USER}/exp015-state (first run, dataset doesn't exist yet)")
