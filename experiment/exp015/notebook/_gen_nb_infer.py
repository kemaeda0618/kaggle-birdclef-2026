"""Generate exp015 inference NB.

Loads ckpt_best_ns22.pth from maekeso/exp015-state, rebuilds model, runs inference
...
cells.append(md_cell(r"""# exp015 — Inference (CPU, internet=off)

Load best ConvNeXt-Pico SED checkpoint from `maekeso/exp015-state`, run inference on
...
- `maekeso/exp015-state` (training ckpts)
...
assert STATE_DIR is not None, (
    "ckpt not found. Attach maekeso/birdclef2026-exp015-train as kernel_sources, "
