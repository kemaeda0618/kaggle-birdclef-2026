"""Poll exp131 v2 training kernel until finished, then pull log + outputs."""
...
REF = "maekeso/birdclef2026-exp131-train-v2"
while True:
    try:
    ...
    time.sleep(60)
out = Path("experiment/exp131/notebook/_out"); out.mkdir(exist_ok=True)
try:
