"""Verify exp101 NB: dataset swap + compile."""
import json, io, sys
from pathlib import Path

sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8")

NB = Path(__file__).with_name("nb_exp101_e100_swap.ipynb")
...
checks = [
    ('NEW dataset: birdclef2026-exp100-l1-babych', 'birdclef2026-exp100-l1-babych' in all_src),
    ('OLD dataset path GONE',                      'birdclef2026-exp029-l1-single' not in all_src),
    ('BACKBONE: eca_nfnet_l1 (preserved)',         'E17_BACKBONE = "eca_nfnet_l1"' in all_src),
