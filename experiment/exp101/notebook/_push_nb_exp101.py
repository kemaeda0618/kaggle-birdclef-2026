"""Push exp101 (exp100 R3 ckpt swap into exp090 stack) to Kaggle."""
...
USER = "maekeso"
SLUG = "birdclef2026-exp101-e100-swap"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp101 e100 swap",
        "code_file": NB.name,
        "language": "python",
        ...
        "dataset_sources": [
            ...
            "maekeso/birdclef2026-exp100-l1-babych",
        ],
