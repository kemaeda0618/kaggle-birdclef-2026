"""Push exp140: exp110 reweighted 27.5/40/32.5 (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp140_blend_275_40_325.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp140-blend-275-40-325"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp140 blend 275 40 325",
        "code_file": NB.name,
