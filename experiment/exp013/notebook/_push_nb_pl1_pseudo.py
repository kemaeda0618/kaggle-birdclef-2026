"""Push exp013 NB1 (pseudo-label generation) to Kaggle as GPU T4x2 NB.

Title is set to slug-form so URL slug stays stable.
"""
...
TITLE = "BirdCLEF2026 exp013 PL1 Pseudo Gen"   # slug ≒ title.lower().replace(' ','-')
