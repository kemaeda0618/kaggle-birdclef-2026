"""Pre-check: extract all cell sources from nb_pl2_sed_train_v2.ipynb,
...
NB = Path(__file__).with_name("nb_pl2_sed_train_v2.ipynb")
...
try:
    ...
    print(f"OK: NB2 v2 syntax check passed ({len(nb['cells'])} cells)")
