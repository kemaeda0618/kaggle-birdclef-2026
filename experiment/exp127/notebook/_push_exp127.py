"""Push exp127 Amphibia-all diagnostic NB."""
...
NB = Path(__file__).with_name("nb_exp127_amphibia_all.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp127-amphibia-all"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp127 amphibia all",
        "code_file": NB.name,
        "language": "python",
