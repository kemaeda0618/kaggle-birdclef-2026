"""Push exp126 external-XC diagnostic NB."""
...
NB = Path(__file__).with_name("nb_exp126_xc_diag.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp126-xc-diag"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp126 xc diag",
        "code_file": NB.name,
        "language": "python",
