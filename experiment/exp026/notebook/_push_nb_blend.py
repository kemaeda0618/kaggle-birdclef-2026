"""Push exp026: NB4 + Tucker + (e17 R2 5-fold weight-averaged + inline ONNX) blend.

slug: birdclef2026-exp026-blend-w35-40-25-e17-5fold-onnx
- exp019 base ratio (w35-40-25)
- e17 単体 → exp020 5-fold weight-averaged + inline ONNX export
- 期待 LB 0.948-0.951
"""
...
NB = Path(__file__).with_name("nb_blend_5fold_onnx.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp026-blend-w35-40-25-e17-5fold-onnx"
TITLE = "birdclef2026-exp026-blend-w35-40-25-e17-5fold-onnx"
