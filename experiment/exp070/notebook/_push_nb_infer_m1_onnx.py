...
NB = Path(__file__).with_name("nb_infer_m1_onnx.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp070-m1-infer-onnx"
TITLE = "birdclef2026 exp070 m1 infer onnx"
