"""Push exp110: exp090 with blend weight (0.30, 0.40, 0.30)."""
...
NB = Path(__file__).with_name("nb_exp110_blend_30_40_30.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp110-blend-30-40-30"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp110 blend 30 40 30",  # 37 chars
        "code_file": NB.name,
        "language": "python",
        ...
        # exp090 baseline と同 sources (Tucker ONNX + exp029 R3 PyTorch)
        "dataset_sources": [
            "jaejohn/perch-meta",
