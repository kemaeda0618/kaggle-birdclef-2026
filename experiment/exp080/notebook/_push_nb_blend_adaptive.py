"""Push exp080a: 3-stream adaptive blend NB."""
...
NB = Path(__file__).with_name("nb_blend_adaptive.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp080a-adaptive-blend"
TITLE = "birdclef2026 exp080a adaptive blend"
