"""Push exp080b: Tucker pseudo gen on XC audio (GPU T4x2)."""
...
NB = Path(__file__).with_name("nb_xc_pseudo.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp080b-xc-pseudo-tucker"
TITLE = "birdclef2026 exp080b xc pseudo tucker"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "kernel_sources": [
            "maekeso/birdclef2026-exp047-xc-api-dl-part1",
