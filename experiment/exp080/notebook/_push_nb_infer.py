"""Push exp080 inference NB (Kaggle CPU sub)."""
...
USER = "maekeso"
SLUG = "birdclef2026-exp080-infer-b0-single"
TITLE = "birdclef2026 exp080 infer b0 single"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "dataset_sources": [],
        "kernel_sources": [
            "maekeso/birdclef2026-exp080-train-b0-combined",
        ],
    }
