"""Generate exp017 NB: eca_nfnet_l0 SED training + pseudo + Kaggle upload (Colab Pro A100).

Design philosophy:
- **Colab Pro A100 single-session**: eca_nfnet_l0 (~24M) で 20 epoch ~7-9h、1-session 完走見込み
- データは Kaggle API direct DL (Drive FUSE 個別 copy を避ける)
- 出力 ckpt は /content/output に保存 + Drive へミラー (epoch ごと)
- exp016 と同じ recipe、backbone のみ差替、epoch 25→20 ([[feedback_default_epochs_20]])
- **train + pseudo + Kaggle upload を 1 ipynb に統合** ([[feedback_train_pseudo_same_ipynb]])

Architecture:
- Backbone: eca_nfnet_l0 (~24M、NFNet 系、BN-free、ECA attention)
...
# Cell 0: Header
# =============================================================================
cells.append(md_cell(r"""# exp017 — eca_nfnet_l0 SED training + Pseudo + Kaggle upload (Colab Pro A100)
...
# =============================================================================
# Cell 14: Pseudo phase header + VRAM cleanup
# =============================================================================
...
# =============================================================================
# Cell 16: Post-processing + Save CSV
# =============================================================================
cells.append(code_cell(r"""# ============================================================
...
# =============================================================================
# Cell 17: Kaggle Dataset upload header
# =============================================================================
cells.append(md_cell(r"""---
