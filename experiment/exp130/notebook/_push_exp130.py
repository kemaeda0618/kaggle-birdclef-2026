"""Push exp130: exp110 + amphibian surgical blend (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp130_amphib_surgical.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp130-amphib-surgical"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp130 amphib surgical",
        "code_file": NB.name,
        ...
        "dataset_sources": [
            ...
            f"{USER}/birdclef2026-amphib-b0-ov",
        ],
