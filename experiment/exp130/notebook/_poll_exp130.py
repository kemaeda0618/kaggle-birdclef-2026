"""Poll exp130 submit NB until finished, then pull log."""
...
REF = "maekeso/birdclef2026-exp130-amphib-surgical"
while True:
    try:
    ...
    time.sleep(60)
out = Path("experiment/exp130/notebook/_out"); out.mkdir(exist_ok=True)
try:
