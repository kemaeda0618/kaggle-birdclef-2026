"""Push e106 3-fold OV conversion NB.

Input:
  - maekeso/birdclef2026-exp029-l1-single (fold 0)
  - maekeso/birdclef2026-exp106-fold1
  - maekeso/birdclef2026-exp106-fold2
  - ttahara/birdclef-2026-download-wheels (openvino wheels)

Output: /kaggle/working/exp106_fold{0,1,2}.xml + .bin
"""
...
NB = Path(__file__).with_name("nb_ov_e106_3fold.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-e106-3fold-ov"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 e106 3fold ov",  # 26 chars
        "code_file": NB.name,
        "language": "python",
