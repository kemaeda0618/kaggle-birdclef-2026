"""Push exp053 Inference NB to Kaggle."""
...
USER = "maekeso"
SLUG = "birdclef2026-exp053-stage2a-infer"
TITLE = "birdclef2026 exp053 stage2a infer"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "is_private": True,
        "enable_internet": False,  # Kernels Only submission
        # CPU only (no machine_shape)
