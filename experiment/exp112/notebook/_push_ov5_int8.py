"""Push OV5 INT8 quantization + error-report NB."""
...
NB = Path(__file__).with_name("nb_ov5_int8.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-ov5-int8-errorcheck"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 ov5 int8 errorcheck",  # 32 chars
        "code_file": NB.name,
        "language": "python",
        "kernel_type": "notebook",
        "is_private": True,
        "enable_internet": True,         # pip install nncf
