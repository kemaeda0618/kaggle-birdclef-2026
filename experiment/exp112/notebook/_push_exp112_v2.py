"""Push exp112 V2 (batched, same slug as V1)."""
...
NB = Path(__file__).with_name("nb_exp112_v7_fold1.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp112-e106-fold12"   # same slug = V2
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp112 e106 fold12",
        "code_file": NB.name,
        "language": "python",
