...
NB = Path(__file__).with_name("nb_anuraset_upload.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp047-anuraset-upload"
TITLE = "birdclef2026 exp047 anuraset upload"
...
with tempfile.TemporaryDirectory() as td:
    ...
    meta = {
        ...
        "competition_sources": [],
        "dataset_sources": [],
        # mount the previous AnuraSet extract NB's OUTPUT
        "kernel_sources": ["maekeso/birdclef2026-exp047-anuraset-extract"],
    }
