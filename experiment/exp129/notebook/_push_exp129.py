...
NB = Path(__file__).with_name("nb_exp129_verify.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp129-verify"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp129 verify",
        "code_file": NB.name,
        "language": "python", "kernel_type": "notebook", "is_private": True,
        "enable_internet": True,
        "competition_sources": ["birdclef-2026"],
        "dataset_sources": [
            "maekeso/birdclef2026-amphib-b0-ov",
