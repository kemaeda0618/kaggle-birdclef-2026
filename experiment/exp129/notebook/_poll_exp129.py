"""Poll exp129 verify kernel until finished, then pull log + CSV."""
...
REF = "maekeso/birdclef2026-exp129-verify"
while True:
    try:
    ...
    time.sleep(45)
out = Path("experiment/exp129/notebook/_out"); out.mkdir(exist_ok=True)
try:
