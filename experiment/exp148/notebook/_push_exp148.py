"""Push exp148: exp110 + post-blend site/hour prior (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp148_postblend_prior.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp148-postblend-prior"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp148 postblend prior",
        "code_file": NB.name,
