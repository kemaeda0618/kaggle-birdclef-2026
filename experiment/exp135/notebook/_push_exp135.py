"""Push exp135: exp110 + amphibian v1 surgical ALPHA=0.3 (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp135_amphib_a03.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp135-amphib-a03"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp135 amphib a03",
        "code_file": NB.name,
