"""Push exp139: exp110 reweighted 25/40/35 (submit NB, internet=False). Same sources as exp110, no amphib."""
...
NB = Path(__file__).with_name("nb_exp139_blend_25_40_35.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp139-blend-25-40-35"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp139 blend 25 40 35",
        "code_file": NB.name,
