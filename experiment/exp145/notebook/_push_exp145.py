"""Push exp145: exp112 V4 ([1,2]+Tucker5) with e29 weight boosted 0.275/0.40/0.325 (submit NB, internet=False)."""
...
NB = Path(__file__).with_name("nb_exp145_fold12_e29boost.ipynb")
USER = "maekeso"; SLUG = "birdclef2026-exp145-fold12-e29boost"
with tempfile.TemporaryDirectory() as td:
    td = Path(td); shutil.copy(NB, td/NB.name)
    meta = {
        "id": f"{USER}/{SLUG}",
        "title": "birdclef2026 exp145 fold12 e29boost",
        "code_file": NB.name,
