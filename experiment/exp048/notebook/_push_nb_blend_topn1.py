"""Push exp048: exp040 base + TopN N=1 PP ablation (paper 256 spec)."""
...
NB = Path(__file__).with_name("nb_blend_topn1.ipynb")
USER = "maekeso"
# Title slugify -> slug
SLUG = "birdclef2026-exp048-topn1-blend"
TITLE = "birdclef2026 exp048 topn1 blend"
