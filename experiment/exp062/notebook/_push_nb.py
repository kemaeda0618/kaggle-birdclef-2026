"""Push exp062 (exp048 + exp032 R2 Aves-only 15%)."""
...
NB = Path(__file__).with_name("nb_blend_aves_exp032.ipynb")
USER = "maekeso"
SLUG = "birdclef2026-exp062-aves-exp032"
TITLE = "birdclef2026 exp062 aves exp032"
